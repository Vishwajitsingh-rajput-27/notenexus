...
![Node.js](https://img.shields.io/badge/Node.js_≥18-339933?style=flat-square&logo=node.js&logoColor=white)
![Express](https://img.shields.io/badge/Express_4-000000?style=flat-square&logo=express&logoColor=white)
![Socket.io](https://img.shields.io/badge/Socket.io_4-010101?style=flat-square&logo=socket.io&logoColor=white)
...
![node-cron](https://img.shields.io/badge/node--cron-2D6A4F?style=flat-square&logoColor=white)
...
![Pinecone](https://img.shields.io/badge/Pinecone_Vector_DB-5D4FE8?style=flat-square&logoColor=white)
...
![Whisper](https://img.shields.io/badge/Groq_Whisper-412991?style=flat-square&logo=openai&logoColor=white)
![Tesseract](https://img.shields.io/badge/Tesseract.js-003366?style=flat-square&logoColor=white)
...
| | |
|:---:|:---:|
| ![Upload](assets/screenshots/upload.png) | ![Flashcards](assets/screenshots/flashcards.png) |
| **Multi-Source Note Upload** | **AI Flashcard Generation** |
| ![Mind Map](assets/screenshots/mindmap.png) | ![Exam Predictor](assets/screenshots/exam-predictor.png) |
| **AI Mind Map** | **Exam Predictor** |
| ![Copilot](assets/screenshots/copilot.png) | ![Analytics](assets/screenshots/analytics.png) |
...
|:---|:---:|:---|
| ![Next.js](https://img.shields.io/badge/Next.js-000?style=flat-square&logo=next.js) **Next.js** | 14.2.5 | React framework — App Router, SSR, file-based routing |
| ![React](https://img.shields.io/badge/React-20232A?style=flat-square&logo=react&logoColor=61DAFB) **React** | 18 | UI rendering |
...
| ![Socket.io](https://img.shields.io/badge/Socket.io-010101?style=flat-square&logo=socket.io) **Socket.io Client** | 4.7 | Real-time bidirectional communication |
...
| Technology | Version | Purpose |
|:---|:---:|:---|
| ![Node.js](https://img.shields.io/badge/Node.js-339933?style=flat-square&logo=node.js&logoColor=white) **Node.js** | ≥ 18 | Server runtime |
| ![Express](https://img.shields.io/badge/Express-000?style=flat-square&logo=express) **Express** | 4.19 | REST API framework — 16 route modules |
| ![Socket.io](https://img.shields.io/badge/Socket.io-010101?style=flat-square&logo=socket.io) **Socket.io** | 4.7 | WebSocket server — rooms, quiz, typing indicators |
...
| Technology | Purpose |
|:---|:---|
| ![MongoDB](https://img.shields.io/badge/MongoDB_Atlas-47A248?style=flat-square&logo=mongodb&logoColor=white) **MongoDB Atlas** | Primary datastore — 8 Mongoose schemas (users, notes, rooms, sessions…) |
| **Pinecone** — 768-dim · cosine · serverless | Vector database for semantic note retrieval |
| ![Cloudinary](https://img.shields.io/badge/Cloudinary-3448C5?style=flat-square&logo=cloudinary&logoColor=white) **Cloudinary CDN** | File and image storage with global edge delivery |

### 🤖 AI & Integrations

| Service | Model | Purpose |
|:---|:---|:---|
| ![Groq](https://img.shields.io/badge/Groq-F55036?style=flat-square) **Groq** | `llama-3.3-70b-versatile` | Flashcards, exam prediction, study planner, AI tutor, copilot, translation |
| **Groq** | `whisper-large-v3` | Voice and audio transcription |
| **Groq Vision** | `llama-4-scout-17b-16e-instruct` | Image OCR — fallback stage 1 |
| ![Gemini](https://img.shields.io/badge/Gemini-4285F4?style=flat-square&logo=google&logoColor=white) **Google Gemini** | `text-embedding-004` | 768-dim note embeddings stored in Pinecone |
| **Google Gemini** | `gemini-1.5-flash` | PDF text extraction — fallback stage 3 |
| **Tesseract.js** | — | Local OCR — fallback stage 2 |
| ![Twilio](https://img.shields.io/badge/Twilio-F22F46?style=flat-square&logo=twilio&logoColor=white) **Twilio** | WhatsApp API | WhatsApp AI study bot (open + linked mode) |
...
| ![Render](https://img.shields.io/badge/Render-46E3B7?style=flat-square&logo=render&logoColor=black) **Render** | Backend hosting — Node runtime, Oregon region |
...
| ![Flashcards](assets/screenshots/flashcards.png) | ![Mind Map](assets/screenshots/mindmap.png) |
|:---:|:---:|
| **Flashcards** | **Mind Map** |
...
| ![Copilot](assets/screenshots/copilot.png) | ![Exam Predictor](assets/screenshots/exam-predictor.png) |
|:---:|:---:|
...
![Group Study](assets/screenshots/group-study.png)
...
![WhatsApp Bot](assets/screenshots/whatsapp.png)
